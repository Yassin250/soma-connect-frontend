...
export const LearnerAccountPage = () => {
  const { user } = useAuth();
  ...
  const roles = (user?.roles?.length ? user.roles : ['LEARNER'])
        ...
        {activeTab === 'overview' && (
          <div className="p-6 sm:p-8 space-y-5 animate-in fade-in slide-in-from-bottom-1 duration-300" key="overview">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-0.5">Your learning account identity.</p>
            </div>
        ...
        {activeTab === 'password' && (
          <div className="p-6 sm:p-8 animate-in fade-in slide-in-from-bottom-1 duration-300" key="password">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-400 mt-0.5">Update your credentials to keep your account secure.</p>
            </div>
