  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {unreadCount > 0 && (
          <button onClick={handleMarkAllRead} className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#171717] text-white text-xs font-semibold hover:bg-black transition-colors active:scale-[0.97]">
              ...
              return (
                <motion.div
                  ...
                  className={`rounded-2xl bg-white p-5 transition-all hover:shadow-sm ${
                    !n.read
                      ? 'border-l-4 border-l-[#171717] border-t border-r border-b border-gray-100 shadow-[0_4px_20px_rgba(23,23,23,0.06)]'
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 mt-3">
                        {n.link && (
                          <Link to={n.link} className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-[#171717] text-white text-[11px] font-semibold hover:bg-black transition-colors">
                            View
                          </Link>
                        )}
                        {!n.read && (
