...
const inputClass =
  'w-full rounded-2xl bg-[#f3f4f6] py-3.5 px-4 text-sm text-gray-900 placeholder-gray-400 outline-none border border-transparent transition-all focus:bg-white focus:border-[#1b1e26]/20 focus:ring-4 focus:ring-[#1b1e26]/5';
        ...
        <div className="w-full max-w-md mx-auto">
          <AnimatePresence mode="wait">
            {step === 'START' && !selectedType ? (
              ...
              >
                <div className="space-y-1.5 mb-8">
                  <h1 className="text-[28px] leading-tight font-semibold text-[#1b1e26] tracking-tight">Choose entity type</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
                  {ENTITY_CARDS.map((card) => (
                    <button
                      ...
                      className="group text-left p-4 rounded-2xl border border-gray-200 bg-white hover:border-[#1b1e26] hover:bg-[#d0f24a]/[0.06] transition-all duration-200"
                    >
                      <span className="w-9 h-9 rounded-xl bg-gray-100 group-hover:bg-[#d0f24a] flex items-center justify-center transition-colors">
                        <svg className="w-5 h-5 text-[#1b1e26]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.7" d={card.icon} />
                        </svg>
                      </span>
                      <p className="mt-3 text-sm font-semibold text-[#1b1e26]">{card.title}</p>
              ...
              >
                <div className="space-y-1.5">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-[13px] font-medium text-gray-500 hover:text-[#1b1e26] transition-colors mb-2"
                  >
                  ...
                  <h1 className="text-[28px] leading-tight font-semibold text-[#1b1e26] tracking-tight">Entity details</h1>
                  <p className="text-sm text-gray-500">Step 2 of 3 — fill initial details and set password.</p>
                </div>

                <div className="px-4 py-2 rounded-xl bg-[#d0f24a]/20 border border-[#d0f24a]/40 text-sm font-semibold text-[#1b1e26]">
            ...
            {step === 'VERIFY_OTP' ? (
              ...
              >
                <div className="space-y-1.5">
                  ...
                  <h1 className="text-[28px] leading-tight font-semibold text-[#1b1e26] tracking-tight">Verify OTP</h1>
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Enter the 6-digit code sent to{' '}
                    <span className="font-semibold text-[#1b1e26] break-all">{emailForOtp}</span>.
                  </p>
                </div>
                ...
                <button
                  ...
                  className="w-full py-3 border border-gray-300 text-[#1b1e26] text-sm font-semibold rounded-xl hover:bg-gray-50 transition-all disabled:opacity-70"
                >
            ...
            {step === 'COMPLETE' ? (
              ...
              >
                <div className="space-y-1.5">
                  <h1 className="text-[28px] leading-tight font-semibold text-[#1b1e26] tracking-tight">Complete profile</h1>
          ...
          <div className="mt-6">
            ...
            <Link
              to="/login"
              className="w-full inline-flex items-center justify-center py-3.5 bg-[#d0f24a] hover:bg-[#c4e83a] text-[#1b1e26] text-sm font-bold rounded-2xl transition-all"
            >
              Log in
            </Link>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="space-y-2">
                <h2 className="text-2xl font-bold text-[#1b1e26]">
