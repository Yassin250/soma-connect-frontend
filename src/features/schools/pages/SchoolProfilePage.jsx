    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 text-center text-red-600">
          ...
          <button onClick={fetchProfile} className="px-4 py-2 bg-[#1b1e26] text-white text-sm font-semibold rounded-xl hover:bg-black transition-colors">Retry</button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
        {/* Header banner */}
        <div className="bg-gradient-to-r from-[#1b1e26] to-[#343b49] p-6 sm:p-8">
        ...
        <div className="p-6 sm:p-8 space-y-8">
          ...
          <section className="space-y-4">
            <h3 className="text-sm font-bold uppercase tracking-[0.2em] text-slate-400 flex items-center gap-2">
              <svg className="w-4 h-4 text-[#1b1e26]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
