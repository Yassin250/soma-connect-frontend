    ...
    <div className="space-y-8 antialiased">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-200 pb-6">
        ...
        <button
          ...
          className="px-5 py-2 text-xs font-bold uppercase tracking-wider bg-[#1b1e26] text-white rounded-xl hover:bg-black transition-all shadow-md flex items-center gap-2"
        >
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between">
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-white border border-slate-200 rounded-xl text-xs font-medium text-slate-800 placeholder-slate-400 focus:outline-none focus:border-[#d0f24a] focus:ring-2 focus:ring-[#d0f24a]/25 transition-all"
          />
        </div>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex flex-col items-end gap-1.5 shrink-0">
                      ...
                      <div className="opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                        <button className="text-[10px] font-semibold text-[#5b6b12] hover:text-[#1b1e26] px-2 py-0.5 rounded bg-[#d0f24a]/20 hover:bg-[#d0f24a]/30 transition-colors">
                          View
                        </button>
