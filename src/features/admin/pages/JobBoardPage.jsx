...
const TYPE_STYLE = {
  'full-time': 'bg-[#3D7FFF]/20 text-white border-[#3D7FFF]/50',
  'part-time': 'bg-[#0A0A0A]/[0.06] text-[#0A0A0A]/70 border-[#0A0A0A]/10',
  ...
  return (
    <div className="space-y-8 antialiased">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          { label: 'Total Listings', value: stats.total, icon: 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', accent: 'border-l-[#3D7FFF]', iconBg: 'bg-[#3D7FFF]/20', iconColor: 'text-white' },
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-slate-100">
                {jobs.map((j) => (
                  <tr key={j.id} className="hover:bg-[#3D7FFF]/[0.08] transition-colors">
                    ...
                    <td className="px-4 py-2.5 text-[13px] text-[#0A0A0A]/80">{j.employer || j.company}</td>
                    <td className="px-4 py-2.5">
                    ...
                    <td className="px-4 py-2.5 text-xs text-slate-500">{j.location || '---'}</td>
                    <td className="px-4 py-2.5 text-xs font-mono text-slate-400">{j.createdAt || j.postedAt}</td>
                  </tr>
                ))}
              </tbody>
            </table>
