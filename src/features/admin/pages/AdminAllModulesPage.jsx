...
export const AdminAllModulesPage = () => {
  ...
  const columns = [
      ...
      render: (m) => (
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <p className="font-medium text-[#1b1e26] truncate max-w-[280px]">{m.title || 'Untitled module'}</p>
    ...
    },
    {
      ...
      render: (m) => (
        <button
          ...
          className="text-[13px] text-[#5b6b12] hover:text-[#1b1e26] hover:underline truncate max-w-[200px] inline-block align-middle text-left"
        >
          {m.courseTitle || '—'}
        </button>
      ),
    },
    {
      ...
      render: (m) => <span className="text-[13px] text-[#1b1e26]/60">{m.entityName || '—'}</span>,
    },
    {
      ...
      render: (m) => (
        <div className="flex justify-end">
          <RowActionMenu
            ...
            items={[
              { label: 'Open course', icon: DockIcons.edit, iconTone: 'text-[#1b1e26]/60', onClick: () => navigate(`/admin/courses/${m.courseId}`) },
              { label: 'Manage modules', icon: DockIcons.edit, iconTone: 'text-[#1b1e26]/60', onClick: () => navigate(`/admin/courses/${m.courseId}/modules`) },
            ]}
          />
        </div>
      ),
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-[19px] font-medium tracking-tight mt-1 text-[#1b1e26]">Modules</h1>
