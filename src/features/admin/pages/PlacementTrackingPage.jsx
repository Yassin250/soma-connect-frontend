...
const STATUS_STYLE = {
  ...
  offered: 'bg-[#3D7FFF]/20 text-[#FFFFFF] border-[#3D7FFF]/50',
  ...
  return (
    <div className="space-y-8 antialiased">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          { label: 'Total Placements', value: stats.total, icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0zM15 11a3 3 0 11-6 0 3 3 0 016 0z', accent: 'border-l-[#3D7FFF]', iconBg: 'bg-[#3D7FFF]/20', iconColor: 'text-[#FFFFFF]' },
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-slate-100">
                {placements.map((p) => (
                  <tr key={p.id} className="hover:bg-[#3D7FFF]/[0.08] transition-colors">
                    ...
                    <td className="px-4 py-2.5 text-[13px] text-[#0A0A0A]/80">{p.employer || p.company}</td>
                    <td className="px-4 py-2.5">
