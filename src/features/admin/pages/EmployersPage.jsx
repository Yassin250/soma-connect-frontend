  ...
  return (
    <div className="space-y-8 antialiased">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          { label: 'Total Employers', value: stats.total, icon: 'M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2', accent: 'border-l-[#3D7FFF]', iconBg: 'bg-[#3D7FFF]/20', iconColor: 'text-[#FFFFFF]' },
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-slate-100">
                {employers.map((e) => (
                  <tr key={e.id} className="hover:bg-[#3D7FFF]/[0.08] transition-colors">
                    ...
                    <td className="px-4 py-2.5">
                      <p className="text-[13px] text-[#0A0A0A]/80">{e.contactName || e.representative}</p>
