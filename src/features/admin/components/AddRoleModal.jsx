...
export const AddRoleModal = ({ isOpen, onClose, onSubmit, editingRole }) => {
  ...
  return createPortal(
    ...
    >
      <div
        className="relative w-full max-w-[520px] max-h-[92vh] overflow-y-auto bg-white rounded-3xl border border-[#0A0A0A]/[0.06] shadow-[0_20px_60px_rgba(27,30,38,0.25)] p-6 sm:p-8 animate-in zoom-in-95 fade-in duration-200"
