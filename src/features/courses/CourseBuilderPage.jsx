                      ...
                      return (
                        <div key={ii} className={`rounded-xl border p-3 space-y-2.5 transition-colors ${missingTitle ? 'border-amber-300 bg-amber-50/40' : 'border-[#1b1e26]/[0.07] bg-[#fdfdfe]'}`}>
                          ...
                          <div className="flex items-center gap-2.5">
                            ...
                            {item.itemType === 'QUIZ' && item.id && (
                              <Link to={`/lecturer/items/${item.id}/questions`} target="_blank" className="px-2.5 py-1 rounded-lg text-[11px] font-semibold text-violet-600 bg-violet-50 hover:bg-violet-100 transition-colors shrink-0">
                                Questions
                              </Link>
                            )}
                            <div className="flex items-center gap-0.5 shrink-0">
